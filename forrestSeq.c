...
#include <stdlib.h>
#include "mpi.h"
#define P 10 //probabilità p che un albero cresca in una cella vuota, 0 <= p <= 100
#define F 10 //probabilità f che un albero si incendii, 0 <= f <= 100
#define S 200 //numero di passi massimo
#define T "🌲"
#define E "💨"
#define B "🔥"
